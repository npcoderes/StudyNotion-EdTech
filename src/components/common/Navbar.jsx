...
const Navbar = () => {
  ...
  return (
    <nav
      className={`z-[1000] flex h-16 w-full items-center justify-center border-b-[0.5px] border-b-richblack-700 text-black translate-y-0 transition-all ${showNavbar} fixed top-0 left-0 right-0 bg-white p-2  `}
    >
