                    ...
                    }
                    {
                        token === null && (
                            <Link to="/login">
                                ...
                                <button className={` px-[12px] py-[8px] text-[#4251f5] rounded-md border-[#4251f5] border`}
                                >
                                    Log in
                                </button>
                            </Link>
                    ...
                    }
                    {
                        token === null && (
                            <Link to="/signup">
                                ...
                                <button className={` px-[12px] py-[8px] text-[#fff] rounded-md border-[#4251f5] bg-[#4251f5] border`}
                                >
                                    Sign Up
                                </button>
                            </Link>
